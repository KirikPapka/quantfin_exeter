...
\texttt{build.sh}, \texttt{wrangler.toml}, \texttt{DEPLOY.md} & Deployment/build metadata for local and hosted execution. \\
...
\texttt{web/export.py} & Static site export: renders pages and precomputes lab fragments into \texttt{dist/} for the Cloudflare deployment. \\
